...
{
    [Serializable]
    public class SerializableDictionaryPathList : IDictionary<string, PathList>, IDictionary
    {
        ...
        public SerializableDictionaryPathList()
        {
            Initialize(0);
        }

        protected SerializableDictionaryPathList(int initialCapacity)
        {
            Initialize(initialCapacity);
        }

        SerializableDictionaryPathList(int staticCapacity, bool forceSize)
        {
        ...
        ICollection<string> IDictionary<string, PathList>.Keys
        {
            get
            {
                if (keys == null) keys = new KeyCollection(this);
        ...
        ICollection<PathList> IDictionary<string, PathList>.Values
        {
            get
            {
                if (values == null) values = new ValueCollection(this);
        ...
        public PathList this[string key]
        {
            get
            {
                int i = FindEntry(key);
        ...
        public void Add(string key, PathList value)
        {
            Insert(key, value, true);
        }

        void ICollection<KeyValuePair<string, PathList>>.Add(KeyValuePair<string, PathList> keyValuePair)
        {
            Add(keyValuePair.Key, keyValuePair.Value);
        }

        bool ICollection<KeyValuePair<string, PathList>>.Contains(KeyValuePair<string, PathList> keyValuePair)
        {
            int i = FindEntry(keyValuePair.Key);
            if (i >= 0 && EqualityComparer<PathList>.Default.Equals(entriesValue[i], keyValuePair.Value))
            {
                return true;
            }
            return false;
        ...
        bool ICollection<KeyValuePair<string, PathList>>.Remove(KeyValuePair<string, PathList> keyValuePair)
        {
            int i = FindEntry(keyValuePair.Key);
            if (i >= 0 && EqualityComparer<PathList>.Default.Equals(entriesValue[i], keyValuePair.Value))
            {
        ...
        public bool ContainsValue(PathList value)
        {
            if (value == null)
            {
            ...
            {
                EqualityComparer<PathList> c = EqualityComparer<PathList>.Default;
                for (int i = 0; i < count; i++)
                {
        ...
        private void CopyTo(KeyValuePair<string, PathList>[] array, int index)
        {
            if (array == null)
            {
            ...
            for (int i = 0; i < count; i++)
            {
                ...
                {
                    array[index++] = new KeyValuePair<string, PathList>(entriesKey[i], entriesValue[i]);
                }
            }
        }
        ...
        IEnumerator<KeyValuePair<string, PathList>> IEnumerable<KeyValuePair<string, PathList>>.GetEnumerator()
        {
            return new Enumerator(this, Enumerator.KeyValuePair);
        }
        ...
        void Initialize(int capacity, bool forceSize)
        {
            ...
            entriesValue = new PathList[size];

            freeList = -1;
        }

        void Insert(string key, PathList value, bool add)
        {
            if (key == null) throw new ArgumentNullException("key");
        ...
        void Resize(int newSize, bool forceNewHashCodes)
        {
            ...
            var newEntriesValue = new PathList[newSize];
            ...
            if (buckets != null)
            {
                ...
                for (int i = buckets[bucket]; i >= 0; last = i, i = entriesNext[i])
                {
                    if (entriesHashCode[i] == hashCode && Comparer.Equals(entriesKey[i], key))
                    {
                        ...
                        entriesValue[i] = default(PathList);
                        freeList = i;
                        freeCount++;
                        version++;
                        return true;
        ...
        public bool TryGetValue(string key, out PathList value)
        {
            int i = FindEntry(key);
            if (i >= 0)
            {
            ...
            value = default(PathList);
            return false;
        }

        bool ICollection<KeyValuePair<string, PathList>>.IsReadOnly
        {
            get { return false; }
        }

        void ICollection<KeyValuePair<string, PathList>>.CopyTo(KeyValuePair<string, PathList>[] array, int index)
        {
            CopyTo(array, index);
        }
        ...
        void ICollection.CopyTo(Array array, int index)
        {
            ...
            KeyValuePair<string, PathList>[] pairs = array as KeyValuePair<string, PathList>[];
            if (pairs != null)
            {
                CopyTo(pairs, index);
            }
            ...
            else
            {
                ...
                try
                {
                    ...
                    for (int i = 0; i < count; i++)
                    {
                        if (entriesHashCode[i] >= 0)
                        {
                            objects[index++] = new KeyValuePair<string, PathList>(entriesKey[i], entriesValue[i]);
                        }
                    }
                }
        ...
        public struct Enumerator : IEnumerator<KeyValuePair<string, PathList>>,
            IDictionaryEnumerator
        {
            private SerializableDictionaryPathList dictionary;
            private int version;
            private int index;
            private KeyValuePair<string, PathList> current;
            ...
            public bool MoveNext()
            {
                ...
                while ((uint)index < (uint)dictionary.count)
                {
                    ...
                    {
                        current = new KeyValuePair<string, PathList>(dictionary.entriesKey[index], dictionary.entriesValue[index]);
                        index++;
                        return true;
                    }
                    index++;
            ...
            public KeyValuePair<string, PathList> Current
            {
                get { return current; }
            }
            ...
            object IEnumerator.Current
            {
                get
                {
                    ...
                    {
                        return new KeyValuePair<string, PathList>(current.Key, current.Value);
                    }
                }
            }
        ...
        [DebuggerDisplay("Count = {Count}")]
        public sealed class ValueCollection : ICollection<PathList>, ICollection
        {
            private SerializableDictionaryPathList dictionary;

            public ValueCollection(SerializableDictionaryPathList dictionary)
            {
                if (dictionary == null)
                {
                    throw new ArgumentNullException("dictionary");
            ...
            public void CopyTo(PathList[] array, int index)
            {
                if (array == null)
                {
                    throw new ArgumentNullException("array");
            ...
            bool ICollection<PathList>.IsReadOnly
            {
                get { return true; }
            }

            void ICollection<PathList>.Add(PathList item)
            {
                throw new NotSupportedException(SR.NotSupported_ValueCollectionSet);
            }

            bool ICollection<PathList>.Remove(PathList item)
            {
                throw new NotSupportedException(SR.NotSupported_ValueCollectionSet);
            }

            void ICollection<PathList>.Clear()
            {
                throw new NotSupportedException(SR.NotSupported_ValueCollectionSet);
            }

            bool ICollection<PathList>.Contains(PathList item)
            {
                return dictionary.ContainsValue(item);
            }

            IEnumerator<PathList> IEnumerable<PathList>.GetEnumerator()
            {
                return new Enumerator(dictionary);
            }
            ...
            void ICollection.CopyTo(Array array, int index)
            {
                ...
                PathList[] values = array as PathList[];
                if (values != null)
                {
                    CopyTo(values, index);
                }
            ...
            public struct Enumerator : IEnumerator<PathList>, System.Collections.IEnumerator
            {
                private SerializableDictionaryPathList dictionary;
                private int index;
                private int version;
                private PathList currentValue;
